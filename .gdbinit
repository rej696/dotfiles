...
# color the remaining lines of the disassembly - default is yellow
set $CONTEXTCOLOR = 1
...
set $COLOR_REGNAME = $MAGENTA
set $COLOR_REGVAL = $YELLOW
set $COLOR_REGVAL_MODIFIED  = $GREEN
...
if $COLOREDPROMPT == 1
        set prompt \033[01;31m(\033[01;32mgdb\033[01;31m) \033[01;32m> \033[00m
end
